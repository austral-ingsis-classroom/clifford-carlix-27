...
public final class Rm implements Command{
    ...
    public Result execute(String input, FileSystem fileSystem) {
        ...
        if (maybeFlag.isEmpty()) {
            // no hay flag, entonces si el target es un directorio debemos mostrar el mensaje de error adecuado
            if (fileSystem instanceof Directory dir) {
                ...
                // si es un file, se puede remover sin flag, delegamos a Remove. Pasamos un target que representa el file a borrar.
